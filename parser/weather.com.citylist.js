...
function parseBaseInfos(){
    var province = $.trim($('div.contentboxTab > h1 > a:last').text());
    var provinceUrl = $.trim($('div.contentboxTab > h1 > a:last').attr('href'));
    
    $('div.conMidtab3 a').each(function(){
        var city = $.trim($(this).text());
        var url = $(this).attr('href');
        
        pushResult(province + '\t' + provinceUrl, city + '\t' + url);
