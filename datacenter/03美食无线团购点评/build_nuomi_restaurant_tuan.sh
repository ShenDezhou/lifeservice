...
# * Filename	 : bin/build_nuomi_restaurant_tuan.sh
# * Description	 : 利用hadoop计算店铺的合并
# * *****************************************************************************/

. ./bin/Tool.sh

Log=logs/nuomi_restaurant_tuan.log


NuomiShopPath=/fuwu/Source/Cooperation/Tuan/Input/nuomi
DianpingShopPath=/fuwu/DataCenter/baseinfo_restaurant
NeedMergeShop=/fuwu/Source/Cooperation/Tuan/tmp/nuomi_dianping_restaurant_shops
MergeHadoopPath=/user/web_tupu/serviceapp/nuomi/merge/restaurant_output
ShopMerge=/fuwu/Source/Cooperation/Tuan/tmp/nuomi_dianping_restaurant_shop_merge
NuomiTuanOnlinePath=/fuwu/Source/Cooperation/Tuan/data/nuomi_restaurant
NuomiTuanOutputPath=/fuwu/Source/Cooperation/Tuan/Output/nuomi_restaurant
...
function extract_dianping_city_shops() {
	...
	LOG "extract dianping restaurant shops done." >> $Log
}
...
function put_to_output() {
	rm -f ./History/nuomi_restaurant/*
	mv $NuomiTuanOutputPath/* ./History/nuomi_restaurant/
	cp $NuomiTuanOnlinePath/* $NuomiTuanOutputPath/
