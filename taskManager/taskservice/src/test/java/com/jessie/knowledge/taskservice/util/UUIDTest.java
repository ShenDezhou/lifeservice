...
public class UUIDTest {
	...
	public static void main(String[] args) {
		//UUID uuid = UUID.fromString("781fb408-eb4c-4b95-9872-3b85d6b24211");
		UUID uuid = UUID.fromString("10d0de03-7066-441f-ab9a-ba22ab82ec25");
		
		System.out.println("UUID String: " + uuid.toString());
		System.out.println("Number of Bytes: "
				+ uuid.toString().getBytes().length);
		System.out.println();
		...
		try {
			...
			System.out.println("Number of Bytes: "
					+ newUUID.toString().getBytes().length);
			System.out.println();
